...
(function (ext) {
    ...
    ext.say = function (text, lang, callback) {
    ...
    ext.get_last_said = function()
    {
        return lastSaid;
    }
    ext.Listen = function(callback)
    {
        var command = {
            '*tag': function (tag) {
                if (calls.length > 0) {
    ...
    var descriptor = {
        blocks: [['w', 'speak %s %s', 'say', 'hello',"en"],['r','last said','get_last_said',''],['w','Listen','Listen','']]
    };
